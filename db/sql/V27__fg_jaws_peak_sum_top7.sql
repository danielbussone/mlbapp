-- 7-year peak WAR for JAWS = **sum** of the seven highest single-season fWAR values (BRef-style), not their mean.
-- Recreates cohort MVs from V26 with corrected ``peak_war_fwar``. Re-run FG consolidated refresh after migrate.
