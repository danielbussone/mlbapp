...
WITH catalog(metric_id, card_role, support_class, primary_object, notes) AS (
  VALUES
    ...
    ('fg_season_pit_fbv', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'TOT row; cohort TBF floor'),
    ('fg_season_pit_fg_o_swing_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'O-Swing% 2002+'),
    ('fg_season_pit_fg_swstr_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'SwStr% 2002+'),
    ('fg_season_pit_fg_zone_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'Zone% 2002+'),
    ('fg_season_pit_fg_gb_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current', 'GB% typed or json'),
    ('fg_season_pit_fg_iffb_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'IFFB% when present'),
    ('fg_season_pit_fg_hard_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'Hard% when present'),
    ('fg_season_pit_hr_fb_pct', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current', 'HR/FB typed or json'),
    ('fg_season_pit_babip', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current', 'BABIP typed or json'),
    ('fg_season_pit_era', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current', 'ERA typed; TOT row'),
    ('fg_season_pit_fip', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current', 'FIP typed; TOT row'),
    ('fg_season_pit_stuff_plus', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_stuff or legacy Stuff+'),
    ('fg_season_pit_location_plus', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_location or legacy Location+'),
    ('fg_season_pit_pitching_plus', 'pitcher', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_pitching or legacy Pitching+'),
    ...
    ('pitch_fg_stuff_plus', 'pitcher_pitch_type', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_s_* 2020+; TBF+type pitch floors'),
    ('pitch_fg_location_plus', 'pitcher_pitch_type', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_l_* 2020+'),
    ('pitch_fg_pitching_plus', 'pitcher_pitch_type', 'runtime_midrank', 'fg_pitching_season_current stats_jsonb', 'sp_p_* 2020+'),
