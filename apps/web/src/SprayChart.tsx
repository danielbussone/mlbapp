...
export function SprayChart({ rows, gameYear }: { rows: SprayRow[]; gameYear: number }) {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 560 }}>
      ...
      <Stack direction="row" flexWrap="wrap" gap={1.25} sx={{ mt: 1 }} alignItems="center">
        {(
          [
            ['single', 'Single'],
            ['double', 'Double'],
          ...
          <Stack key={k} direction="row" alignItems="center" spacing={0.5}>
            <Box sx={{ width: 10, height: 10, borderRadius: '50%', bgcolor: HIT_COLORS[k] }} />
