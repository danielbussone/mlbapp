...
import styles from './FrvBreakdownPrototype.module.css';
  ...
  return (
    <Stack spacing={0.25}>
      <Stack direction="row" justifyContent="space-between" alignItems="baseline">
        ...
        <Typography variant="caption" className={styles.tabularStrong}>
          {v > 0 ? `+${v}` : String(v)}
        </Typography>
      </Stack>
      <Box className={styles.barTrack} aria-label={`${label}: ${v} runs`}>
        <Box className={styles.barCenter} />
        {v < 0 && (
          <Box
            sx={{
              position: 'absolute',
        ...
        {v === 0 && (
          <Typography variant="caption" className={styles.barZeroLabel}>
            0
          </Typography>
        )}
      </Box>
      {valueDetail != null && valueDetail !== '' && (
        <Typography variant="caption" color="text.secondary" className={styles.detailCaption}>
          {valueDetail}
        </Typography>
      )}
    </Stack>
    ...
    <Card variant="outlined" className={styles.card}>
      <CardContent className={styles.cardContent}>
        <Stack spacing={1.25}>
          ...
          {showFieldingBlock && (
            <>
              ...
              {isIF && !is1B && row.inf_of_runs !== 0 && (
                <Typography variant="caption" color="text.secondary" className={styles.captionTightNeg}>
          ...
          {showCatching && (
            <>
              <Divider className={showFieldingBlock ? styles.dividerFielding : undefined} />
              <Typography variant="overline" className={styles.overline}>
                Catching
              </Typography>
              {isC && (
                <Typography variant="caption" color="text.secondary" className={styles.captionTight}>
          ...
          {!isC && !showCatching && (
            <Typography variant="caption" color="text.secondary" className={styles.italicCaption}>
...
export function FrvBreakdownPrototype() {
  return (
    <Container maxWidth={false} className={styles.page}>
      ...
      <Box className={styles.cardGridStretch}>
        <Stack spacing={0.75}>
      ...
      <Typography variant="h6" className={styles.sectionSpaced}>
      ...
      <Box className={styles.cardGridStart}>
      ...
      <Box className={styles.stressGrid}>
        <Stack spacing={1.5}>
          <Typography variant="subtitle2" className={styles.subtitleStrong}>
            Bad range · good arm
          </Typography>
