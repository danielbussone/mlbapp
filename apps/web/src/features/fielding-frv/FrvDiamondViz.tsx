...
import { INFIELD_100, ssFieldPosition } from '@/features/fielding-oaa/infieldFieldGeometry.js';
import { InfieldPositionReferenceSvg } from '@/features/fielding-oaa/InfieldPositionReferenceSvg.js';
import { SPRAY_FIELD_VB as VB, sprayFieldImageHref } from '@/features/spray-chart/sprayFieldConstants.js';
import styles from './FrvDiamondViz.module.css';
...
export function FrvDiamondViz({
  ...
  return (
    <Box className={styles.wrap}>
      ...
      <Box className={styles.svgFrame} style={{ aspectRatio: `${VB} / ${VB}` }}>
        <svg
          width="100%"
          height="100%"
          viewBox={`0 0 ${VB} ${VB}`}
