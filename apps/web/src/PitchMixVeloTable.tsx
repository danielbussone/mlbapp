...
function VeloRowSvg(props: {
  ...
  const minBarH = comboTall ? 1.15 : 0;
  const leagueMph =
...
export function PitchMixVeloTable({
  ...
  /** Shared cell look so two abutted tables read as one. */
  const comboCellSx = { fontSize: '0.8125rem', verticalAlign: 'middle' as const };
              ...
              <TableHead>
                <TableRow sx={{ minHeight: COMBO_HEAD_ROW_MIN_PX }}>
                  <TableCell sx={{ py: 0.75, pr: 0.5, pl: 0.25, verticalAlign: 'bottom', borderRight: 'none' }}>
                    <Box sx={{ width: handBlockWidthPx, textAlign: 'center' }}>
