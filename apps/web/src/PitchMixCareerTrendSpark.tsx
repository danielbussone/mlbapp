  ...
  return (
    <Box sx={{ mt: 1 }}>
      ...
      <Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mt: 0.5 }}>
        {topTypes.map((pt) => (
          <Typography key={pt} variant="caption" sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <Box component="span" sx={{ width: 10, height: 3, bgcolor: pitchTypeMovementColor(pt), borderRadius: 99 }} />
            {pitchTypeName(pt)}
          </Typography>
        ))}
      </Stack>
