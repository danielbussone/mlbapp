...
export function stripTrailingGenerationalSuffixes(parts) {
    const out = [...parts];
...
export function stripGenerationalSuffixFromQuery(q) {
 ...
 */
export function normalizePlayerNameQuery(q) {
    let s = q.trim();
    if (!s)
        return s;
 ...
 */
export function narrowCandidatesByGenerationalHint(rawNameQuery, candidates) {
